...
export default function Header() {
    const firebasect = useContext(FirebaseContext) as any
                        ...
                        {userAux? (
                            <>
                                ...
                                <button
                                    type="button"
                                    title="SIgn Out"
                                    onClick={() => firebasect.firebaseInit.firebase_.auth().signOut()}
                                    onKeyDown={(e) => {
                                        if (e.key === 'Enter') {
                                            firebasect.firebaseInit.firebase_.auth().signOut();
                                        }
                                    }}
                                >
                                    <svg
